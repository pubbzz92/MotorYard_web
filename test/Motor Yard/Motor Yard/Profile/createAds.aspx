<%@ Page Title="" Language="C#" MasterPageFile="~/Profile/Adssub.master" AutoEventWireup="true" CodeBehind="createAds.aspx.cs" Inherits="Motor_Yard.Profile.createAds" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BodyProfile" runat="server">

    <table cellpadding="0" cellspacing="0" style="width: 701px;margin: 8px 0 30px 7px;   ">
        <tr>
